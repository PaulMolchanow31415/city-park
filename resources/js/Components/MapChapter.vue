...
<template>
    <div>
        <TitleUnderlined class="container mb-10">Контактная информация</TitleUnderlined>
                ...
                <div v-show="react.isOpenPopup"
                    ...
                    <div class="line">
                        ...
                        <p>
                            ...
                            352630, Краснодарский край, г. Белореченск, ул. Гоголя, 61.
                        </p>
                    </div>
                    <div class="line">
                        <div class="pt-6 w-5">
                        ...
                        <div>
                            ...
                            <ul>
                                <li><a href="tel:88001002441" class="underline">8-800-100-24-41 (звонок по России
                                    бесплатный)</a></li>
                    ...
                    <div class="line">
                        ...
                        <div>
                            ...
                            <ul>
                                <li><a target="_blank" href="https://vk.com/cityparkvip" class="underline">
                                    ВК: vk.com/cityparkvip
                                </a></li>
                                <li><a target="_blank" href="https://ok.ru/cityparkvip" class="underline">
                                    OК: ok.ru/cityparkvip
                                </a></li>
                                <li><a target="_blank" href="https://www.instagram.com/cityparkvipru/"
                                       class="underline">
                                    Instagram: cityparkvipru
                                </a></li>
                                <li><a target="_blank" href="mailto:belcitypark@mail.ru" class="underline">
                                    e-mail: belcitypark@mail.ru
                                </a></li>
                            </ul>
                        </div>
                    </div>
