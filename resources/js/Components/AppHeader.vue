      ...
      <ul class="flex gap-5">
        ...
        <li>
          <Dropdown align="center" trigger="hover" :animated="true">
            <template #trigger>
              <Link class="link" :href="route('rest')">
                <FontAwesomeIcon size="xs" :icon="['fas', 'utensils']"/>
                Ресторан и летнее кафе
              </Link>
            </template>
            <ol>
              <li><Link class="link__dropdown-item" :href="route('rest.menu')">Меню</Link></li>
              ...
              <li><Link class="link__dropdown-item" :href="route('rest.news')">Новости и мероприятия</Link></li>
        ...
        <li>
          <Dropdown align="center" trigger="hover" :animated="true">
            <template #trigger>
              <Link class="link" :href="route('hotel')">
