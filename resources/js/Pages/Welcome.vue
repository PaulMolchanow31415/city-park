...
const state = reactive({ isBounce: false})
function bounce() {
    setInterval(() => state.isBounce = !state.isBounce, 2000)
}
...
<template>
    ...
    <div
        ...
        <div v-if="canLogin" class="heading">
        ...
        <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                ...
                type="button">
            <FontAwesomeIcon :bounce="state.isBounce" :icon="['fas', 'circle-check']" />
            Toggle modal
...
.heading {
    @apply sm:fixed sm:top-0 sm:end-0 p-6 text-end z-10;
}
</style>
